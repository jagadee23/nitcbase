...
int BlockAccess::renameRelation(char oldName[ATTR_SIZE], char newName[ATTR_SIZE])
{
    ...
    */
    ...
    recBuffer.setRecord(record, searchRes.slot);
        /*
    ...
    {
        searchRes = BlockAccess::linearSearch(ATTRCAT_RELID, attrName, oldRelationName, EQ);
            recBuffer = RecBuffer(searchRes.block);
        recBuffer.getRecord(record, searchRes.slot);
        record[ATTRCAT_ATTR_NAME_INDEX] = newRelationName;
        recBuffer.setRecord(record, searchRes.slot);
    }
    return SUCCESS;
}
...
int BlockAccess::renameAttribute(char relName[ATTR_SIZE], char oldName[ATTR_SIZE], char newName[ATTR_SIZE])
{
    ...
    while (true)
    {
        ...
        searchRes = BlockAccess::linearSearch(ATTRCAT_RELID, attrName, relNameAttr, EQ);
